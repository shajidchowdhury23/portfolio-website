// --- EASILY CUSTOMIZABLE EDUCATION DATA ---
const educationData = [
    {
        institution: "Ideal School and College",
        degree: "SSC<br>Grade: GPA-5.00 ",
        location: "Banasree,Dhaka",
        year: "2023"
    },
    {
        institution: "Dhaka College",
        degree: "HSC<br>Grade: GPA-5.00",
...
function renderEducation() {
    ...
    educationData.forEach(item => {
        ...
        // Use template literals for clean HTML injection
        itemDiv.innerHTML = `
            <h3 class="institution-name">${item.institution}</h3>
            <p class="degree-title">${item.degree}</p>
